...
class MistralAPI:
    ...
    def _clean_api_key(self, api_key: str | None) -> str:
    ...
    def list_models(self) -> dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to list models: {e!s}") from None
    ...
    def chat_completion(
        ...
        try:
            ...
            raise RuntimeError(f"Chat completion failed: {e!s}") from None
